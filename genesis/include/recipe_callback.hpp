...
public:
	...
	virtual ~recipe_callback() noexcept
	{
		// Nothing to do...
	}


	SXE_NO_COPY( recipe_callback )
	...
	//!\param _condition_name Name of the condition block that is executed.
